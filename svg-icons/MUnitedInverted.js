  ...
  _createClass(MUnited, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'svg',
        { height: '32', id: 'metro-united', xmlns: 'http://www.w3.org/2000/svg', viewBox: '0 0 210 200' },
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement('path', { id: 'path-2', 'data-name': 'path', fill: '#fff', d: 'M208.69.33a2.55,2.55,0,0,0-2.57,0L105,62,3.87.37A2.55,2.55,0,0,0,0,2.55v195A2.45,2.45,0,0,0,2.45,200H52a2.45,2.45,0,0,0,2.45-2.45V90.31l48.09,28.94a5.65,5.65,0,0,0,2.46.89,5.66,5.66,0,0,0,2.45-.89L208.75,58.59c1.09-.64,1.25-1.33,1.25-3,0-.75,0-53,0-53A2.55,2.55,0,0,0,208.69.33Z' })
        )
      );
    }
  }]);
