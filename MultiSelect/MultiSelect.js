...
module.exports = React.createClass({ displayName: 'exports',
  ...
  render: function render() {
    ...
    return div({
      ...
      tabIndex: '0',
      'aria-hidden': true
    }, div({ className: 'react-select-box-label' }, this.label())), this.renderOptionMenu(), this.isMultiple() ? this.renderClearButton() : '', this.renderNativeSelect());
  },
  ...
  renderOptionMenu: function renderOptionMenu() {
    ...
    */
    return div({
      ...
      id: 'filterInputDiv'
    }, this.renderFilterField()) : '', div({
      className: 'sectionOptions'
    }, this.state.searchText.length === 0 ? this.options().map(this.renderOption) : this.state.filteredOptions.map(this.renderOption)))
    // this.renderCloseButton()
    );
  },

  renderFilterField: function renderFilterField() {
    return input({
      type: 'text',
  ...
  filterRecords: function filterRecords(e) {
  ...
  renderOption: function renderOption(option, i) {
    ...
    return a({
      ...
      onBlur: this.handleBlur,
      onFocus: this.handleFocus
    }, _typeof(option.label) === 'object' ? option.label[0] : option.label);
  },
