...
var NoData = function (_React$Component) {
  ...
  _createClass(NoData, [{
    ...
    value: function render() {
      var message = this.props.message || 'No data found.';
      return _react2.default.createElement(
        'div',
        { className: 'text-center card-block no-borders' },
        _react2.default.createElement(
          'div',
          { className: 'text-muted font-thin', style: { lineHeight: '15rem', fontSize: '16px' } },
          message
        )
      );
    }
